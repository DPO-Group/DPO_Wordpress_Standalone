...
class Dpo
{
    ...
    protected static $test_company_token = '9F416C11-127B-4DE2-AC7F-D5710E4C5E0A';
    protected static $test_service_type = '3854';
    ...
    public function __construct($test_mode)
    {
        ...
        if ($test_mode) {
            $this->company_token = self::$test_company_token;
            $this->service_type  = self::$test_service_type;
